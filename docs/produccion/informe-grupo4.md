...
## 4.3. Verificacion de observabilidad

> Seccion reservada para que los integrantes responsables de observabilidad completen la evidencia de OpenTelemetry, Prometheus, Grafana y el dashboard RED.
...
Antes de iniciar la API se ejecuta un job temporal:
...
- Captura de `docker images` mostrando reduccion de tamanos.
- Captura de `docker ps` mostrando servicios `healthy`.
- Captura de endpoint `/health`.

## 4.5. Presentacion

> Seccion reservada para que el grupo complete el guion final de la presentacion oral, incluyendo la demo de observabilidad, capturas y cierre general.

## Entregable de Fase 4

| # | Archivo | Ubicacion |
|---|---|---|
| 8 | Informe del grupo | `docs/produccion/informe-grupo4.md` |

## Criterios de evaluacion - Fase 4

| Criterio | Estado |
|---|---|
| Verificacion completa con metricas documentadas | Completo para Docker y seguridad. Observabilidad pendiente por responsables. |
| Presentacion oral | Estructura propuesta. Capturas y dashboard pendientes. |
